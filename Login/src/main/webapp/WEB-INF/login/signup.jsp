...
<body>
  ...
  <form action="signup.do" align=center>
    ...
    <div class="form-group">
      <input name="memId" type="text" placeholder="원하시는ID를 입력하세요">
      <input type="button" value="중복">
    </div><br>
    <!--닉네임 입력 영역-->
    <div class="form-group">
      <input name="memName" type="text" placeholder="원하시는 NickName를 입력하세요">
      <input type="button" value="중복">
    </div><br>

    <!--비밀번호 입력 영역-->
    <div class="form-group">
      <input name="memPwd" type="password" placeholder="pw8자이상 적어주세요">
      <input type="button" value="중복">
    </div>
    <br>
    <div class="form-group">

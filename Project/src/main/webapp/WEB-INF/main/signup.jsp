...
<body>
  ...
  <form action="signup.do" align=center>
    ...
    <div class="form-group">
      <input name="mb_id" type="text" placeholder="아이디를 입력하세요">
      <input type="button" value="중복">
    </div><br>
    <!--닉네임 입력 영역-->
    <div class="form-group">
      <input name="mb_name" type="text" placeholder="닉네임을 입력하세요">
      <input type="button" value="중복">
    </div><br>

    <!--비밀번호 입력 영역-->
    <div class="form-group">
      <input name="mb_pw" type="password" placeholder="패스워드를 입력하세요">
      <input type="button" value="중복">
    </div>
    <br>
    <div class="form-group">
    ...
    <div class="form-group">
      <input type="text" placeholder="챌린지 목표금을 입력하세요">
    </div>
    <br>
